...
enum FormatCommand: String, CaseIterable, Identifiable {
    ...
    var defaultShortcut: KeyboardShortcutSetting {
        ...
        case .heading1:        return .init(key: "1", modifiers: [.command, .shift])
        case .heading2:        return .init(key: "2", modifiers: [.command, .shift])
        case .heading3:        return .init(key: "3", modifiers: [.command, .shift])
        case .heading4:        return .init(key: "4", modifiers: [.command, .shift])
        case .heading5:        return .init(key: "5", modifiers: [.command, .shift])
        case .heading6:        return .init(key: "6", modifiers: [.command, .shift])
